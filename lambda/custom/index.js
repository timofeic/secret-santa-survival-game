...
const languageStrings = {
  en: {
    translation: {
      ...
      SKILL_NAME: 'Tim\'s survival guide',
      WELCOME_MESSAGE: 'Welcome to %s. You can ask a question like, how do I build a %s? ... Now, what can I help you with?',
      WELCOME_REPROMPT: 'For instructions on what you can say, please say help me.',
      DISPLAY_CARD_TITLE: '%s  - Recipe for %s.',
      HELP_MESSAGE: 'You can ask questions such as, how do I make a %s, or, you can say exit...Now, what can I help you with?',
