...
module.exports = {
  'RECIPE_EN_GB': {
    'fire': 'In order to make a fire, you need three things. Fuel, oxygen and heat. Your fuel must be dry, and your best bet is to find wood from trees. You need to start small and find things that burn very easily, such as small twigs, leaves and paper... Next you need oxygen or air, so you\'re kinda screwed if you\'re in a confined space, with limited oxygen. You\'ll likely die before you light a fire. Anyway, I digress. Finally you need heat. Heat can be produce from a flame, spark or friction. To create spark, try brush two very hard objects together, such as a flint.',
    'space blank': 'A space blanket can be found in a pharmacy',
    'water': 'You have a couple of options to purify water, reliably. Option 1. Find water purifying tablets such as Iodine or Chlorine. These can be found in supermarkets or pharmacies. Option 2. Boil water, you\'ll need to find a heat source to do this. Ask me, Alexa, how do I make a fire?',
    'survival kit': 'You will need water purifying tablets, a fire starting flint, a knife and a space blanket. Ask me how to purify water.',
